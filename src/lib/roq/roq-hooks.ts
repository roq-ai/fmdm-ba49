...
export function useParkFindMany<
  T extends Prisma.parkFindManyArgs,
  R extends GetFindResult<Prisma.$parkPayload<DefaultArgs>, T>[],
>(args?: Prisma.SelectSubset<T, Prisma.parkFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useParkFindMany', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.park.findMany(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useParkCount<T extends Prisma.parkCountArgs, R extends number>(
  args?: Prisma.SelectSubset<T, Prisma.parkCountArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useParkCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.park.count(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useParkFindManyWithCount<
  T extends Prisma.parkFindManyArgs,
  R extends { data: GetFindResult<Prisma.$parkPayload<DefaultArgs>, T>[]; count: number },
>(args?: Prisma.SelectSubset<T, Prisma.parkFindManyArgs>, options?: RequestOptions, swrOptions?: SWRRequestOptions<R>) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useParkFindManyWithCount', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.park.findManyWithCount(args, options);
      return result as R;
    },
    {
      ...swrOptions,
...
export function useParkFindFirst<
  T extends Prisma.parkFindFirstArgs,
  R extends GetFindResult<Prisma.$parkPayload<DefaultArgs>, T>,
>(
  args?: Prisma.SelectSubset<T, Prisma.parkFindFirstArgs>,
  options?: RequestOptions,
  swrOptions?: SWRRequestOptions<R>,
) {
  const roq = useRoqClient();
  const key = JSON.stringify(['useParkFindFirst', args || {}]);
  return useSWR<R, Error>(
    key,
    async () => {
      const result = await roq.park.findFirst(args, options);
      return result as R;
    },
    {
      ...swrOptions,
