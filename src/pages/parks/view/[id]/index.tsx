...
import { useParkFindFirst, useRoqClient } from 'lib/roq';

import { ParkInterface } from 'interfaces/park';

function ParkViewPage() {
  ...
  const { data, error, isLoading } = useParkFindFirst(queryParams, {}, { disabled: !id });
            ...
            <FormWrapper wrapperProps={{ gap: 3, p: 4 }}>
              <Flex alignItems="center" w="full" justifyContent={'space-between'}>
                ...
                {hasAccess('park', AccessOperationEnum.UPDATE, AccessServiceEnum.PROJECT) && (
                  <NextLink href={`/parks/edit/${id}`} passHref legacyBehavior>
                    <Button
              ...
              <EntityImage entity="park" entityId={id} />
              <List
                w="100%"
                css={{
                  '> li:not(:last-child)': {
